    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="mt-8">
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            required
                            defaultValue={title}
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 shadow focus:border-blue-500 block w-full p-2"
                            placeholder='Add Title'
                        />
                    </div>
                    <div>
                        <label className="block mb-2 text-sm font-medium text-gray-900">Blog Tags</label>
                ...
                <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Blog Body</label>
                    <textarea
                        rows={10}
